...
#define dbl4 double, double, double, double, // 2 parameter
#define dbl3 double, double, double, // 1 parameter
...
{
  m.def("dnorm", &stats::dnorm<const double, const double, const double, const bool>, 
        "x"_a, "mu"_a, "sigma"_a, "log_form"_a=true);
  m.def("dnorm", &stats::dnorm<Eigen::Ref<const Mxd>, const double, const double, const bool>, 
        "X"_a, "mu"_a, "sigma"_a, "log_form"_a=true);
}
